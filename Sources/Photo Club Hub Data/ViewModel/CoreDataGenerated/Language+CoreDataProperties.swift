...
extension Language {
    ...
    // internal(set): only the package decides which languages are supported. Keep it when regenerating this file.
    @NSManaged nonisolated public internal(set) var isSupported: Bool
